...
import { withCsrfHeader, clearLegacyAuthStorage } from '../utils/authSecurity';
...
// Add cookie credentials and CSRF protection for mutating admin requests
axiosInstance.interceptors.request.use(
    (config) => {
        config.withCredentials = true;
        config.headers = withCsrfHeader(config.headers || {}, config.method);
        return config;
    },
    (error) => {
